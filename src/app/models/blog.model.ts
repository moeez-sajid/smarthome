...
export interface ContentBlock {
  type: 'heading'| 'h3-heading'  | 'rich-text'| 'text' | 'content-break' | 'text-break' | 'image' | 'video' | 'quote' | 'product' | 'code' | 'comparison-table' | 'numbered-list' | 'unordered-list' | 'product-carousel' | 'recommended-products' | 'internal-article-link' | htmlContent;
